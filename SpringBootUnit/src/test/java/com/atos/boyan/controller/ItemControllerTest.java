package com.atos.boyan.controller;
...
import com.atos.boyan.business.ItemBusinessService;
...
public class ItemControllerTest {
	...
	public void itemFromBusinessService_basic() throws Exception {
		...
		when(businessService.retrieveHardcodedItem()).thenReturn(new Item(2, "Item2", 20, 5));

		MvcResult result = mockMvc.perform(request)
				.andExpect(status().isOk())
				.andExpect(content().json("{id: 2,name:Item2,price:20}"))
				.andReturn();
	}
